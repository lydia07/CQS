...
def eval(out_file, src_file, tgt_file, isDIn = False, num_pairs = 500):
    ...
    with open(tgt_file, "r") as infile:
        ...
        for line in infile:
            pair = {}
            pair['tokenized_sentence'] = str(cnt)
            pair['tokenized_question'] = line[:-1]
            pairs.append(pair)
            cnt += 1
...
if __name__ == "__main__":
    ...
    parser.add_argument("-out", "--out_file", dest="out_file", default="../result/pointer_maxout_ans/generated.txt", help="output file to compare")
    parser.add_argument("-src", "--src_file", dest="src_file", default="../result/bert_embeddings/src.txt", help="src file")
    parser.add_argument("-tgt", "--tgt_file", dest="tgt_file", default="../result/pointer_maxout_ans/golden.txt", help="target file")
